...
-(void)generateCardSet{
  ...
  [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Joker]];
  
  for (int i=0;i<4; i++) {
    [cardsStack_ addObject: [[FZCard alloc] initWithCardType:FZCardType_Mosquito]];
  }
  
  for (int i=0;i<5; i++) {
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Whale]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Elephant]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Crocodile]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_PolarBear]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Lion]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Seal]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Fox]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Perch]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Hedgehog]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Fish]];
    [cardsStack_ addObject:[[FZCard alloc] initWithCardType:FZCardType_Mouse]];
  }
...
-(FZCard*)dealCardToPlayer{
  ...
  if (remainToDealCardCount_>0) {
    ...
    //ret = [[FZCard alloc] initWithCardType:card.cardType_];
...
-(void)setCurrentCards:(FZCards*)cards{
  ...
  currentCards_ = [[FZCards alloc] initWithCardArray:cards.cardsArray_];
}
